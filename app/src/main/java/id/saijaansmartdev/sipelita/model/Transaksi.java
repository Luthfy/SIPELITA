...
public class Transaksi {
    ...
    private ArrayList<TransaksiList> data;

    public Transaksi(ArrayList<TransaksiList> data) {
        this.data = data;
    }

    public ArrayList<TransaksiList> getData() {
        return data;
    }

    public void setData(ArrayList<TransaksiList> data) {
        this.data = data;
    }
    ...
    public class Invoiced {
        ...
        public Invoiced(String id, String code, String event_id, String user_id, String status, String nip, String name, String birthplace, String birthday, String address, String phone, String jenkel, String agency, String agency_address, String agency_province, String agency_city, String agency_district, String agency_village, String work_of_unit, String unit_of_work, String work_category, String work_position_name, String group_id, String position_id, String education_id, String majors, Integer graduation, String created_at, String updated_at) {
            this.id = id;
            this.code = code;
    ...
    public class TransaksiList {
        ...
        public TransaksiList(String id, String officer_id, String customer_id, String code_prefix, String code_suffix, String datetime_in, String datetime_out, String invoiced_type, String invoiced_id, String desc, Integer total, Integer paidoff, Integer is_company, Integer is_booking, String created_at, String updated_at, Invoiced invoiced) {
            this.id = id;
