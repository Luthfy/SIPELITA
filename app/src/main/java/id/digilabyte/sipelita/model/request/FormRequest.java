...
public class FormRequest {
    ...
    public Integer getAgency_province() {
        return agency_province;
    }

    public void setAgency_province(Integer agency_province) {
        this.agency_province = agency_province;
    }

    public Integer getAgency_city() {
        return agency_city;
    }

    public void setAgency_city(Integer agency_city) {
        this.agency_city = agency_city;
    }

    public Integer getAgency_district() {
        return agency_district;
    }

    public void setAgency_district(Integer agency_district) {
